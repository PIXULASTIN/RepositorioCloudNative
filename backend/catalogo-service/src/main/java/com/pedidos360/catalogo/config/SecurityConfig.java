    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/catalog/products/**").hasAnyRole("CLIENTE", "OPERADOR", "ADMIN")
                .requestMatchers(HttpMethod.POST, "/api/catalog/products/*/descontar-stock").hasAnyRole("OPERADOR", "ADMIN")
